        ...
        <div class="w-full max-w-md space-y-8">
            ...
            <form action="{{ route('login.submit') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="email" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-black focus:border-black transition-all" placeholder="Please enter your email">
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" id="loginPass" name="password" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-black focus:border-black transition-all pr-12" placeholder="••••••••" value="">
                        
                        <button type="button" onclick="togglePassword('loginPass', 'loginEye')" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-black focus:outline-none p-1">
                            <div id="loginEye">
