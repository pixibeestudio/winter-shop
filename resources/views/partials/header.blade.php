<header class="fixed w-full top-0 z-50 bg-white border-b border-gray-100 transition-all duration-300" id="main-header">
    <div class="container mx-auto px-6 h-20 flex justify-between items-center relative">
        ...
        <div class="lg:hidden flex items-center">
            <button onclick="toggleMobileMenu()" class="text-gray-900 focus:outline-none p-2">
        ...
        <div class="flex items-center gap-5">
            ...
            @auth
                <div class="relative group h-20 flex items-center"> <button class="text-gray-900 hover:text-brand-dark transition-colors flex items-center gap-2 py-2">
    ...
    <div id="search-overlay" class="fixed inset-0 bg-white z-[70] hidden flex-col animate-fade-in">
        ...
        <div class="flex-1 flex flex-col items-center justify-center px-4">
            ...
            <p class="mt-4 text-gray-400 text-sm">Hit Enter to search or ESC to close</p>
        </div>
    </div>
...
<script>
    // 1. Logic cho Mobile Menu (Giữ nguyên)
    ...
    // 2. Logic cho Search Overlay (MỚI)
