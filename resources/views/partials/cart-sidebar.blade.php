<div class="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div class="flex gap-4 animate-fade-in">
                ...
                <div class="flex-1 flex flex-col justify-between">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <button onclick="removeFromCart('{{ $key }}')" class="text-red-400 hover:text-red-600 text-xs underline decoration-dotted transition-colors">Remove</button>
                    </div>
                </div>
            </div>
        @endforeach
    @else
        <div class="h-full flex flex-col items-center justify-center text-gray-400">
            ...
            <button onclick="toggleCart(false)" class="mt-4 text-brand-dark font-semibold hover:underline">Start Shopping</button>
        </div>
    @endif
</div>
