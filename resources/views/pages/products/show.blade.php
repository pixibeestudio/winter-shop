        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div class="lg:sticky lg:top-24 h-fit">
                ...
                <div class="mt-8 flex gap-4">
                    ...
                    <button id="addToCartBtn" class="flex-1 bg-brand-dark text-white rounded-full font-bold text-lg hover:bg-black transition-all shadow-xl hover:shadow-2xl disabled:opacity-50 disabled:cursor-not-allowed">
