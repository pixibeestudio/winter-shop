    ...
    <section class="relative h-screen w-full overflow-hidden bg-gray-900 text-white">
        ...
        <div class="absolute inset-0 flex items-center justify-center text-center z-10 px-4">
            <div class="space-y-6 max-w-4xl">
                <p id="slide-sub"
                    class="text-sm md:text-base font-bold tracking-[0.2em] uppercase text-white/80 translate-y-10 opacity-0 transition-all duration-1000 delay-300">
                    New Collection 2025
                </p>

                <h1 id="slide-title"
                    class="text-5xl md:text-8xl font-serif italic font-bold tracking-tight leading-tight translate-y-10 opacity-0 transition-all duration-1000 delay-500">
                    Outrageous <br> <span
                        class="not-italic text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400">Fashion</span>
                </h1>

                <div id="slide-btn" class="pt-8 translate-y-10 opacity-0 transition-all duration-1000 delay-700">
                    <a href="{{ route('shop.index') }}"
                        class="inline-block bg-white text-black px-10 py-4 rounded-none font-bold uppercase tracking-widest hover:bg-brand-dark hover:text-white transition-all transform hover:scale-105 shadow-2xl">
                        Shop Collection
                    </a>
                </div>
            </div>
        ...
        <button onclick="changeSlide(-1)"
            class="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 border border-white/30 rounded-full items-center justify-center hover:bg-white hover:text-black transition-all z-20 hidden md:flex">
        ...
        <button onclick="changeSlide(1)"
            class="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 border border-white/30 rounded-full items-center justify-center hover:bg-white hover:text-black transition-all z-20 hidden md:flex">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="relative h-[500px] group overflow-hidden cursor-pointer">
                    <img src="https://images.unsplash.com/photo-1551488852-080175d27b87?q=80&w=800"
                    ...
                    <div class="absolute bottom-10 left-10 text-white">
                        ...
                        <a href="#"
                            class="text-sm font-bold uppercase tracking-widest border-b-2 border-white pb-1">Shop Now</a>
                    </div>
                </div>
                <div class="relative h-[500px] group overflow-hidden cursor-pointer">
                    <img src="https://images.unsplash.com/photo-1545594861-3bef43ff22c7?q=80&w=800"
                        class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                    <div class="absolute inset-0 bg-black/10 group-hover:bg-black/30 transition-colors"></div>
                    <div class="absolute bottom-10 left-10 text-white">
                ...
                <div class="relative h-[500px] group overflow-hidden cursor-pointer">
                    <img src="https://images.unsplash.com/photo-1539533018447-63fcce2678e3?q=80&w=800"
                        class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                    <div class="absolute inset-0 bg-black/10 group-hover:bg-black/30 transition-colors"></div>
                    <div class="absolute bottom-10 left-10 text-white">
